...
from ml_service.ml_service import app as ml_app, MLService, TransactionFeatures
from api_gateway.api_gateway import app as gateway_app, AuthenticationService
from risk_scoring.risk_scoring_service import app as risk_app, RiskScoringEngine, TransactionData
